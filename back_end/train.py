...
class NeRFSystem(LightningModule):
    ...
    def training_step(self, batch, batch_nb):
        ...
        self.psnr_values.append(psnr_)
        # Plot the loss and PSNR curves
        plt.clf()
        plt.plot(range(len(self.loss_values)), self.loss_values, 'r-', label='Loss')
        # plt.plot(range(len(self.psnr_values)), self.psnr_values, 'b--', label='PSNR')
